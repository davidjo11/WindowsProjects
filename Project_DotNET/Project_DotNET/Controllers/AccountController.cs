...
namespace Project_DotNET.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, birthday = model.birthday, firstName = model.firstName, lastName = model.lastName, firstDay = model.firstDay };
